...
function TasksPageContent() {
    ...
    const handleStartTask = async (taskId)=>{
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/tasks/".concat(taskId, "/start"), {
                method: "POST",
                headers: {
                    Authorization: "Bearer ".concat(token),
                    "Content-Type": "application/json"
    ...
    const handleStopTask = async (taskId)=>{
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/tasks/".concat(taskId, "/stop"), {
                method: "POST",
                headers: {
                    Authorization: "Bearer ".concat(token),
                    "Content-Type": "application/json"
    ...
    const handleCompleteTask = async (taskId)=>{
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/tasks/".concat(taskId, "/complete"), {
                method: "POST",
                headers: {
                    Authorization: "Bearer ".concat(token),
                    "Content-Type": "application/json"
    ...
    const handleAddAssignee = async (taskId, userId)=>{
        try {
            ...
            const response = await fetch("http://localhost:5000/api/tasks/".concat(taskId, "/assignees"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: "Bearer ".concat(token)
    ...
    const handleUpdateProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TasksPageContent.useCallback[handleUpdateProgress]": async (taskId, percentage, phase)=>{
            try {
                ...
                const response = await fetch("http://localhost:5000/api/tasks/".concat(taskId, "/progress"), {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: "Bearer ".concat(token)
